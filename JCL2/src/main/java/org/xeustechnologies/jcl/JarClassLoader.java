...
public class JarClassLoader extends AbstractClassLoader {
    ...
    public void unloadClass(String className) {
        if( logger.isLoggable( Level.FINER ) )
            logger.finer( "Unloading class " + className );
    ...
    class LocalLoader extends ProxyClassLoader {
        ...
        public Class loadClass(String className, boolean resolveIt) {
            ...
            if( result != null ) {
                if( logger.isLoggable( Level.FINER ) )
                    logger.finer( "Returning local loaded class [" + className + "] from cache" );
                return result;
            }
            ...
            if( logger.isLoggable( Level.FINER ) )
                logger.finer( "Return new local loaded class " + className );
            return result;
        }
        ...
        public InputStream loadResource(String name) {
            ...
            if( arr != null ) {
                if( logger.isLoggable( Level.FINER ) )
                    logger.finer( "Returning newly loaded resource " + name );
